			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.ChenZirong.model.Order o=(com.ChenZirong.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.ChenZirong.dao.UserDao userDao=new com.ChenZirong.dao.UserDao();
						...
						<%
							...
							String paymentType=com.ChenZirong.model.Payment.findByPaymentId(con,n);
							 %>
